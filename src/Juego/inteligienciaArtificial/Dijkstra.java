package Juego.inteligienciaArtificial;
...
public class Dijkstra extends Thread {
	...
	//ok
	public Dijkstra(final Point centroCalculo, final int anchoMapaEnTiles,final int altoMapaEnTiles, final ArrayList<Rectangle> zonasSolidas) {
	...
	public void reiniciarYEvaluar(final Point centroCalculo) 
        {
            ...
            int valor = (int)centroCalculo.getX();
            
            valor = valor + 1;
            
            //System.out.println("centro calculo " + valor);
