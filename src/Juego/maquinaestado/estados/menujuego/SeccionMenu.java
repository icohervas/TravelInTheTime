...
import Juego.herramientas.GeneradorTooltip;
...
public abstract class SeccionMenu {
	...
	public void dibujarEtiquetaActiva(final Graphics g) 
		...
		DibujoDebug.dibujarRectanguloRelleno(g, etiquetaMenu, Color.white);
                ...
                //declaramos e instanciamos un nuevo rectangulo con las coordenadas del boton etiquetemenu x e y, y la anchura de 5 y altura la misma que el boton.
		final Rectangle marcaActiva = new Rectangle(etiquetaMenu.x, etiquetaMenu.y, 5, etiquetaMenu.height);
                //dibujamos el rectangulo pasando como parametros el objeto graphic , el rectangulo marcaactiva y un color.en este caso el naranja.
		DibujoDebug.dibujarRectanguloRelleno(g, marcaActiva, new Color(0xff6700));
                //escribimos el texto, pasado por parametros dentro de la etiqueta activa o boton activo.  centrando el texto en el rectangulo etiqueta menu.
		DibujoDebug.dibujarString(g, nombreSeccion, etiquetaMenu.x + 15, etiquetaMenu.y + 12, Color.black);
	}
