...
public class Constantes {
	...
	public static int ANCHO_JUEGO = 1024;
	public static int ALTO_JUEGO = 768;

	// public static int ANCHO_PANTALLA_COMPLETA = 1920;
	// public static int ALTO_PANTALLA_COMPLETA = 1080;

	public static int ANCHO_PANTALLA_COMPLETA = 1024;
	...
	public static String RUTA_PERSONAJE_PISTOLA = "/imagenes/hojasPersonajes/4.png";
        public static String RUTA_PERSONAJE_ESCOPETA = "/imagenes/hojasPersonajes/3.png";
	...
	public static String RUTA_ARMAS = "/imagenes/hojasObjetos/armas.png";
        public static String RUTA_ARMA_ESCOPETA = "/imagenes/hojasObjetos/escopeta.png";
        public static String RUTA_MENU_COMENZAR = "/imagenes/iconos/time1.jpg";
