...
public abstract class Objeto {
	...
	public abstract Sprite obtenerSprite();
        public abstract Sprite obtenerSpriteEscopeta();
	...
	public Rectangle obtenerPosicionFlotante() {
        ...
        //creamos un metodo setter para establecer el rectangulo del menu.
	public void establecerPosicionMenu(final Rectangle posicionMenu) {
		this.posicionMenu = posicionMenu;
	}
//creamosun setter para establecer la posicion del rectangulo del menu flotante.
